...
<html>
    ...
    <body>
        ...
        <div id="main">           
            ...
            <form action="modifyRole.action" method="post" class="main_form" id="modifyRoleForm">
                <div class="text_info clearfix"><span>角色名称：</span></div>
                <div class="input_info">
                	<input type="hidden"  name="role.id" value="1"/>
                    <input type="text" name="role.name" class="width200" id="name" value="管理员"/>
                ...
                <div class="input_info_high">
                    ...
                    <!--数据库遍历出所有的权限-->
                	<ul>
                		<li><input type="checkbox"  name="role.privilegeIds" value="1" checked="checked"/><span>管理员1</span></li>
                		<li><input type="checkbox"  name="role.privilegeIds" value="2" checked="checked"/><span>管理员2</span></li>
